...
## Step 1 -- Draw bounding boxes around detected cups and compute flow ROIs -- run yolo post detectron2 to only select bounding boxes where spoon was identified##
