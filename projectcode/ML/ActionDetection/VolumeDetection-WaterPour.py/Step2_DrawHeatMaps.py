...
OUTPUT_DIR = "/app/mediaFiles/output/videoOutputs/DetectedFrames/water_volume_output/inferred_volume/"
FRAMES_DIR = "/app/mediaFiles/output/videoOutputs/DetectedFrames/water_volume_output/yolopass/clean_frames/"                          # annotated frames with boxes
CSV_ROI    = "/app/mediaFiles/output/videoOutputs/DetectedFrames/water_volume_output/yolopass/flow_rois.csv" # os.path.join(OUTPUT_DIR, "flow_rois.csv")
...
DIFF_THR   = 8        # gray delta
# Optical flow (Farnebäck) gates for “strong downward vertical motion”
MAG_THR    = 1.0       # min flow magnitude (px/frame)
VY_THR     = 0.6       # min positive vy
VERT_RATIO = 2.0       # |vy| >= VERT_RATIO * |vx|
