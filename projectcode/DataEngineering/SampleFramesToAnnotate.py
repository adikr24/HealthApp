...
SRC_DIR = Path("/app/mediaFiles/videos/InputVideos/VideosToAnnotate/VideoInfFile/HoldingTofu")
DST_DIR = Path("/app/mediaFiles/videos/InputVideos/VideosToAnnotate/VideoInfFile/AnnotateImages/HoldingTofu")
